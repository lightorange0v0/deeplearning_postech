...
def plot_2d_contour(surf_file, surf_name='train_loss', vmin=0.1, vmax=10, vlevel=0.5, show=False): # vmin=0.1, vmax=10, vlevel=0.5
...
def plot_contour_trajectory(surf_file, dir_file, proj_file, surf_name='loss_vals',
    ...
    my_x_p=pf['proj_xcoord']
    my_y_p=pf['proj_ycoord']
    plt.plot( np.array( my_x_p [:]), np.array(my_y_p [:]), marker='.')
