...
from dataset.models.fcnn import CustomFCNN
...
def crunch(surf_file, net, w, s, d, dataloader, loss_key, acc_key, comm, rank, args):
    ...
    #         if i < 5 - 1:
    #             print(f"Retrying to open file: {surf_file} (attempt {i + 1})")
    #             time.sleep(2)
    #         else:
    #             raise
    f = h5py.File(surf_file, 'r+' if rank == 0 else 'r')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mpi', '-m', action='store_true', help='use mpi') # true로 두니까 잘 안 됨..왜지.. (병렬처리 툴임)
    ...
    parser.add_argument('--batch_size', default=1, type=int, help='minibatch size') # 128

    # additional parameters (수정)
    ...
    parser.add_argument("--units") # "[10,20,30,40]"
    parser.add_argument("--param_limit", type=int, default=15000)
    parser.add_argument("--input_size", type=int, default=40)
    parser.add_argument("--output_size", type=int, default=10)

    # data parameters
    parser.add_argument('--dataset', default='mnist1d', help='cifar10 | imagenet')
    parser.add_argument('--datapath', default='mnist1d', metavar='DIR', help='path to the dataset')
    ...
    # model parameters
    parser.add_argument('--model', default='fcnn', help='model name')
    parser.add_argument('--model_folder', default='', help='the common folder that contains model_file and model_file2')
    parser.add_argument('--model_file', default='/Users/yeonjoo/Desktop/대학원/24년 1학기/딥러닝/weight/train_2_500000.pt', help='path to the trained model file')
